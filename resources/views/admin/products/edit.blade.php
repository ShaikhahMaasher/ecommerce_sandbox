                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <textarea id="short_description" name="short_description" class="form-control" rows="3"
                                                placeholder="Enter a short description of the product...">{{ $product->short_description }}</textarea>
                                        </div>
                                    </div>
                                    <!-- /. short description -->
                                    ...
                                    <div class="form-group">
                                        <div class="pad col-sm-12">
                                            <textarea id="description" name="description" rows="10" cols="80" value="{{ $product->description }}"
                                                placeholder="Here is to add a full description of the product...">{{$product->description}}</textarea>
                                        </div>
                                    </div>
                                    <!-- /. description -->
                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="stock_number" name="stock_number"
                                                    value="{{ $product->stock_number }}" placeholder="Stock Number">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /. Stock number -->
                    ...
                    <section class="col-md-3">
                        <div class="box box-solid">
                            ...
                            <div class="box-footer">
                                ...
                                <a href="{{ route('product.delete', $product->id) }}" onclick="event.preventDefault();
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content product-category">
                                        ...
                                        <li id="">
                                            <label class="">
                                                <input value="{{ $category->id }}" type="checkbox" name="categ[]"
                                                    {{ $product->checkUserCategory($product->categories, $category) }}>
                                                {{ __($category->name) }}
                                            </label>
                                ...
                                <div class="tab-pane" id="most_used">
                                    ...
                                    perferendis et distinctio esse? Repellat assumenda dolorum earum dignissimos molestias
                                    voluptatem, aspernatur, quibusdam provident unde saepe tenetur incidunt.
                                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Beatae recusandae eius sequi
                                    architecto veniam nesciunt laudantium, repellat laborum corrupti placeat quibusdam
                                    ipsam voluptates accusantium nulla quasi perspiciatis, libero, officiis amet?
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident, commodi quae!
                                    Eligendi et, cupiditate deleniti tenetur quibusdam laborum dolor error esse, enim aut
                                    deserunt minus? Hic excepturi asperiores ipsa nobis.
                        ...
                        <div class="box box-solid">
                            ...
                            <div class="box-body product-publish">
                                <div>
                                    ...
                                    <a class="pointer" id="remove-feature-id" data-id="{{ $product->id }}">{{ __('Remove
                                        image') }}</a>
                                    @else
                        ...
                        <div class="box box-solid">
                            ...
                            <div class="box-body product-publish">
                                <a href="#" class="open-image-modal" data-toggle="modal" data-target="#image-modal">{{
                                    __('Update product gallery images')}}</a>
                            </div>
                        </div>
                        <!-- /.box-footer -->
                    </section>
