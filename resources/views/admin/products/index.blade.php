...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <a class='col-sm-4' href="products/create">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="center">
                        ...
                        @else
                        <img src="{{ Storage::disk('local')->url('img-placeholder.png') }}" alt="{{$product->title}}"
                            width="30px" height="30px">
                        @endif
                    </td>
                    <td class="mailbox-star"><a href="#"><i class="fa fa-star-o text-yellow"></i></a></td>
                    <td class="product-title long-text"><a href="/admin/products/{{$product->id}}/edit">{{
                            $product->title }}</a></td>
                    <td>{{ $product->sku }}</td>
                    <td>
